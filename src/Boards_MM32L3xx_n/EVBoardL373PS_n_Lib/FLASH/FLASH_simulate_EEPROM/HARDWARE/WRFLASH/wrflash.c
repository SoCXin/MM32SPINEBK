...
* @version V1.3.9
* @date    28/08/2019
* @brief   This file provides all the wrflash firmware functions.
******************************************************************************
* @copy
*
...
void ONCHIP_FLASH_Write(u32 WriteAddr, u16 *pBuffer, u16 NumToWrite)
{
    ...
    secoff = (offaddr % ONCHIP_FLASH_SECTOR_SIZE) / 2;		//在扇区内的偏移(2个字节为基本单位.)
    secremain = ONCHIP_FLASH_SECTOR_SIZE / 2 - secoff;		//扇区剩余空间大小
