...
void usb_in_handle( void)       // IN Request Received
{
    ...
    else
    {
        ...
        {
            if(USB_SEND_OPEN_STALL[EPIN])
            {
                USB->rEP_HALT = (1 << EPIN); //all epn except ep0 send stall
#ifdef UART_PRINTF
...
#endif
    {
        ...
        do
        {
            ...
            if(ch == 0)
            {
                ...
                //					USB->rINT_STATE = USB_INT_DMA_CH0;
                //					break;
                //				}
            }
            else
            {
                ...
                //					USB->rINT_STATE = USB_INT_DMA_CH1;
                //					break;
                //				}
            }
        }
